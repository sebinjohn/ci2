...
# build.sbt
WVPASS ../../../bump-scala-version.sh "com.wix" "accord-specs2-3-x" "1.0"
WVPASS grep '    "com.wix"       %% "accord-specs2-3-x"  % "1.0" % "test"' build.sbt

# project/build.scala
WVPASS ../../../bump-scala-version.sh "org.apache.commons" "commons-lang3" "4.0"
WVPASS grep '          , "org.apache.commons"     %  "commons-lang3"            % "4.0"' project/build.scala

# project/plugins.sbt
WVPASS ../../../bump-scala-version.sh "au.com.cba.omnia" "humbug-plugin" "1.0"
